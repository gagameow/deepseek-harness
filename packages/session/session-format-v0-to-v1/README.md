...
Released subagent descriptor versions 2 and 3 retain their original payloads through migration. An explicitly empty version 2 persona is preserved, as accepted by its released producer. Non-string personas remain invalid. Version 2 cannot contain the version 3 reasoning-effort field; unsupported or malformed records remain rejected.
